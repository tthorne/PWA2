...
try{
	$st = $db->prepare("
		INSERT INTO users 
		(user_n, user_p, salt, email, first_name, last_name, phone, city, state, zipcode, avatar, stable)
		VALUES (:user, :pass, :salt, :email, :firstname, :lastname, :phone, :city, :state, :zipcode, :avatar, :stable)
	");
	$st->execute(array(
		":user"=>$username,
		":pass"=>$hashed["hash"],
